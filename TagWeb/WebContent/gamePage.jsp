...
<script type="text/javascript" class="code-js">
	$(document).ready(function() {
			var boardType = "GAME";
	    	var url = "http://13.124.92.184:9320/board/list?boardType=" + boardType;
			$('#gridGame').DataTable({
                ...
                columns : [
                    ...
                    {data: "account.level"},
                    {data: "account.icon.iconName"},
                    {data: "account.nickName"},
                    {data: "title"},
                    {data: "viewCount"},
                    {data: "createdDate"},
                    {data: "previewImageUrl", "render": function (data) {
                    	//alert(data);
                    	if(data != null)
...
<table id="gridGame" class="table table-striped table-bordered table-hover" >
    <thead>
        <tr>
            <th>icon</th>
            <th>level</th>
