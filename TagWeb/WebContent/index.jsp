...
<script src="assets/plugins/bower_components/jquery/dist/jquery.js"></script>
<script src="assets/plugins/bower_components/underscore/underscore.js"></script>
<script src="assets/plugins/bower_components/backbone/backbone.js"></script>
<script src="assets/plugins/json-example/basic-dummy.js"></script>
<script src="assets/plugins/json-example/test.json"></script>

<link href="pages/css/pages-icons.css" rel="stylesheet" type="text/css">
<link class="main-stylesheet" href="pages/css/themes/light.css"	rel="stylesheet" type="text/css" />


<link href="assets/plugins/bower_components/tui-grid/dist/tui-grid.min.css" rel="stylesheet" type="text/css">
<script
	src="assets/plugins/bower_components/tui-pagination/dist/tui-pagination.js"></script>
<script
	src="assets/plugins/bower_components/tui-code-snippet/dist/tui-code-snippet.js"></script>
<script
	src="assets/plugins/bower_components/tui-date-picker/dist/tui-date-picker.js"></script>
<script src="assets/plugins/bower_components/tui-grid/dist/tui-grid.js"></script>
...
<body class="fixed-header menu-pin">
	...
	<nav class="page-sidebar" data-pages="sidebar">
		...
		<div class="sidebar-menu">
			...
			<ul class="menu-items">
				...
				<li class=""><a href="#"> <span class="title">청원 게시판</span>
	...
	<div class="page-container">
		...
		<div class="header ">
			...
			<div class="">
				...
				<a href="#"
					class="btn btn-link text-primary m-l-20 d-none d-lg-inline-block d-xl-inline-block">Add
					New Item</a> <a href="#"
					class="search-link d-none d-lg-inline-block d-xl-inline-block"
			...
			<div class="d-flex align-items-center">
				...
				<ul
					class="d-lg-inline-block d-none notification-list no-margin b-grey b-r no-style p-l-30 p-r-20">
									...
									<div class="notification-body scrollable">
										...
										<div class="notification-item unread clearfix">
											...
											<div class="heading open">
												<a href="#" class="text-primary pull-left"> <i
												...
												<div class="more-details">
													<div class="more-details-inner">
														<h5 class="semi-bold fs-16">
															“Apple’s Motivation - Innovation <br> distinguishes
															between <br> A leader and a follower.”
														</h5>
										...
										<div class="notification-item unread clearfix">
											<div class="heading">
												...
												<a href="#" class="text-primary pull-left"> <span
				...
				<div class="dropdown pull-right d-lg-inline-block d-none">
					...
					<div class="dropdown-menu dropdown-menu-right profile-dropdown"
						...
						<a href="#" class="dropdown-item"><i class="pg-settings_small"></i>
							...
							class="pg-outdent"></i> Feedback</a> <a href="#"
							class="dropdown-item"><i class="pg-signals"></i> Help</a> <a
							href="#" class="clearfix bg-master-lighter dropdown-item"> <span
							class="pull-left">Logout</span> <span class="pull-right"><i
	...
	<div id="quickview" class="quickview-wrapper" data-pages="quickview">
		...
		<ul class="nav nav-tabs">
			<li class="" data-target="#quickview-notes" data-toggle="tab"><a
				href="#">Notes</a></li>
			<li data-target="#quickview-alerts" data-toggle="tab"><a
				href="#">Alerts</a></li>
							...
							<div class="list-view-group-container">
								...
								<ul>
									...
									<li class="alert-list">
										<!-- BEGIN Alert Item Set Animation using data-view-animation !-->
										<a href="javascript:;"
										class="p-t-10 p-b-10 align-items-center" data-navigate="view"
									...
									<li class="chat-user-list clearfix"><a
										...
										data-navigate="view" class="" href="#"> <span
											class="thumbnail-wrapper d32 circular bg-success"> <img
												...
												data-src-retina="assets/img/profiles/1x.jpg"
												data-src="assets/img/profiles/1.jpg" alt=""
												src="assets/img/profiles/1.jpg" class="col-top">
										</span>
											<p class="p-l-10 ">
					...
					<div class="view chat-view bg-white clearfix">
						...
						<div class="b-t b-grey bg-white clearfix p-l-10 p-r-10">
							<div class="row">
								...
								<div
									class="col-2 link text-master m-l-10 m-t-15 p-l-10 b-l b-grey col-top">
	...
	<!-- END OVERLAY -->
	<!-- BEGIN VENDOR JS -->
	<script src="assets/plugins/feather-icons/feather.min.js"
	...
	<script src="assets/plugins/jquery-ui/jquery-ui.min.js"
		type="text/javascript"></script>
	<script src="assets/plugins/popper/umd/popper.min.js"
		type="text/javascript"></script>
